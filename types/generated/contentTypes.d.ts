...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    mainColor: Schema.Attribute.Enumeration<
      ['lime', 'pink', 'blue', 'white', 'black']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    titleColor: Schema.Attribute.Enumeration<['mainColor', 'white', 'black']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'mainColor'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiArticlesArchiveArticlesArchive
  extends Struct.SingleTypeSchema {
  collectionName: 'articles_archives';
  info: {
    displayName: 'ArticlesArchive';
    pluralName: 'articles-archives';
    singularName: 'articles-archive';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::articles-archive.articles-archive'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Shopify collections synchronized from the Shopify store';
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    thankYouDescription: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    thankYouTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottomLinks: Schema.Attribute.Component<'common.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGeneralGeneral extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::general.general'
    >;
    marquee: Schema.Attribute.Component<'common.menu-marque', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeProductHomeProduct extends Struct.SingleTypeSchema {
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroArticle: Schema.Attribute.Component<'homepage.hero-article', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::articles-archive.articles-archive': ApiArticlesArchiveArticlesArchive;
